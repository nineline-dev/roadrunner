  ...
  return (
    <section className="py-24 px-6 bg-gold-light border-t border-b border-gold/20">
      <div ref={sectionRef} className="fade-up max-w-3xl mx-auto text-center">
        <h2 className="font-display font-bold text-3xl sm:text-4xl md:text-6xl text-text-primary leading-tight mb-6">
          Ready to make your
          <br />
          <span className="text-gold">listing shine?</span>
        </h2>
        <p className="font-body text-text-secondary text-lg mb-10 max-w-xl mx-auto">
          Join 500+ Phoenix listings shot by Roadrunner Media. Fast turnaround. Unmatched quality.
        </p>
        <a
        ...
        <p className="font-body text-text-secondary/60 text-xs mt-3">
          No payment required · 2-min booking
        </p>

        <div className="flex flex-wrap gap-6 justify-center mt-8 text-sm text-text-secondary font-body">
